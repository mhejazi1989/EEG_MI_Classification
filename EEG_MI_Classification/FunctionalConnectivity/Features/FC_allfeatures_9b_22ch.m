...
for numSubjects = 1 :totalSubjects
    ...
    load(fullfile(mypath, sprintf('categorized_9b_values_sub%03d.mat', numSubjects)))
    ...
    for condIdx = 1:length(conditions)
        ...
        save(fullfile(mypath, sprintf('upper_triangle_connectivity_9b_22ch_sub%03d_%s.mat', numSubjects, conditions{condIdx})), ...
