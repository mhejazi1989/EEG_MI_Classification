...
for numSubjects = 17
    ...
    matFilePath = fullfile(myPath, sprintf('sub%03d_9b_AllFeatureMatrix.mat', numSubjects));
    ...
    % Initialize a new cell array to hold the selected top 90 feature indices for each iteration and fold
    ...
    for iteration = 1:numIteration
        for c = 1:numel(classProbs)
            ...
            for fold = 1:K
                ...
                % Store the top 90 feature indices for both coh
    ...
    % Save the top 90 selected feature indices for each method
    save(fullfile(savePath, sprintf('topSelectedFeatureIndices_corr_9b_Sub-%03d.mat', numSubjects)), 'selectedTopFeatureIndices_corr');
    save(fullfile(savePath, sprintf('topSelectedFeatureIndices_coh_9b_Sub-%03d.mat', numSubjects)), 'selectedTopFeatureIndices_coh');
    save(fullfile(savePath, sprintf('topSelectedFeatureIndices_plv_9b_Sub-%03d.mat', numSubjects)), 'selectedTopFeatureIndices_plv');

    fprintf('Saved top 90 selected feature indices for Subject %d (corr, coh, plv).\n', numSubjects);

    % Save the full list of selected feature indices
    save(fullfile(savePath, sprintf('selectedFeatureIndices_corr_9b_Sub-%03d.mat', numSubjects)), 'selectedFeatureIndices_corr');
    save(fullfile(savePath, sprintf('selectedFeatureIndices_coh_9b_Sub-%03d.mat', numSubjects)), 'selectedFeatureIndices_coh');
    save(fullfile(savePath, sprintf('selectedFeatureIndices_plv_9b_Sub-%03d.mat', numSubjects)), 'selectedFeatureIndices_plv');

    fprintf('Saved all selected feature indices for Subject %d (corr, coh, plv).\n', numSubjects);

    %% Save Local Accuracies (LDA, SVM, DT)
    save(fullfile(savePath, sprintf('localAccuracies_lda_corr_9b_Sub-%03d.mat', numSubjects)), 'localAccuracies_lda_corr');
    save(fullfile(savePath, sprintf('localAccuracies_lda_coh_9b_Sub-%03d.mat', numSubjects)), 'localAccuracies_lda_coh');
    save(fullfile(savePath, sprintf('localAccuracies_lda_plv_9b_Sub-%03d.mat', numSubjects)), 'localAccuracies_lda_plv');

    save(fullfile(savePath, sprintf('localAccuracies_svm_corr_9b_Sub-%03d.mat', numSubjects)), 'localAccuracies_svm_corr');
    save(fullfile(savePath, sprintf('localAccuracies_svm_coh_9b_Sub-%03d.mat', numSubjects)), 'localAccuracies_svm_coh');
    save(fullfile(savePath, sprintf('localAccuracies_svm_plv_9b_Sub-%03d.mat', numSubjects)), 'localAccuracies_svm_plv');

    save(fullfile(savePath, sprintf('localAccuracies_dt_corr_9b_Sub-%03d.mat', numSubjects)), 'localAccuracies_dt_corr');
    save(fullfile(savePath, sprintf('localAccuracies_dt_coh_9b_Sub-%03d.mat', numSubjects)), 'localAccuracies_dt_coh');
    save(fullfile(savePath, sprintf('localAccuracies_dt_plv_9b_Sub-%03d.mat', numSubjects)), 'localAccuracies_dt_plv');
    ...
    if exist('meanAccuracies_coh_SVM', 'var') && exist('meanAccuracies_coh_DT', 'var') && exist('meanAccuracies_coh_LDA', 'var')
        save(fullfile(savePath, sprintf('FC_Accuracies_coh_9b_Sub-%03d.mat', numSubjects)), 'meanAccuracies_coh_SVM', 'meanAccuracies_coh_DT', 'meanAccuracies_coh_LDA');
    ...
    if exist('meanAccuracies_plv_SVM', 'var') && exist('meanAccuracies_plv_DT', 'var') && exist('meanAccuracies_plv_LDA', 'var')
        save(fullfile(savePath, sprintf('FC_Accuracies_plv_9b_Sub-%03d.mat', numSubjects)), 'meanAccuracies_plv_SVM', 'meanAccuracies_plv_DT', 'meanAccuracies_plv_LDA');
    ...
    if exist('meanAccuracies_corr_SVM', 'var') && exist('meanAccuracies_corr_DT', 'var') && exist('meanAccuracies_corr_LDA', 'var')
        save(fullfile(savePath, sprintf('FC_Accuracies_corr_9b_Sub-%03d.mat', numSubjects)), 'meanAccuracies_corr_SVM', 'meanAccuracies_corr_DT', 'meanAccuracies_corr_LDA');
