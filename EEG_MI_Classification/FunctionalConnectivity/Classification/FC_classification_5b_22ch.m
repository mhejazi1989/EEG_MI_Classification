...
for numSubjects = 23:totalSubjects
    ...
    for condIdx = 1:length(conditions)
        ...
        matFilePath = fullfile(myPath, sprintf('upper_triangle_connectivity_5b_22ch_sub%03d_%s.mat', numSubjects, conditions{condIdx}));
    ...
    BandValues_REST_corr = [BandValues.REST.Delta.correlation, BandValues.REST.Theta.correlation, BandValues.REST.Alpha.correlation, BandValues.REST.Beta.correlation, BandValues.REST.Gamma.correlation];
    BandValues_MI_FT_corr = [BandValues.MI_FT.Delta.correlation, BandValues.MI_FT.Theta.correlation, BandValues.MI_FT.Alpha.correlation, BandValues.MI_FT.Beta.correlation, BandValues.MI_FT.Gamma.correlation];
    BandValues_MI_DB_corr = [BandValues.MI_DB.Delta.correlation, BandValues.MI_DB.Theta.correlation, BandValues.MI_DB.Alpha.correlation, BandValues.MI_DB.Beta.correlation, BandValues.MI_DB.Gamma.correlation];
    BandValues_ME_DB_corr = [BandValues.ME_DB.Delta.correlation, BandValues.ME_DB.Theta.correlation, BandValues.ME_DB.Alpha.correlation, BandValues.ME_DB.Beta.correlation, BandValues.ME_DB.Gamma.correlation];
    BandValues_ME_FT_corr = [BandValues.ME_FT.Delta.correlation, BandValues.ME_FT.Theta.correlation, BandValues.ME_FT.Alpha.correlation, BandValues.ME_FT.Beta.correlation, BandValues.ME_FT.Gamma.correlation];

    % Prepare band values for classification based on coherence
    BandValues_REST_coh = [BandValues.REST.Delta.coherence, BandValues.REST.Theta.coherence, BandValues.REST.Alpha.coherence, BandValues.REST.Beta.coherence, BandValues.REST.Gamma.coherence];
    BandValues_MI_FT_coh = [BandValues.MI_FT.Delta.coherence, BandValues.MI_FT.Theta.coherence, BandValues.MI_FT.Alpha.coherence, BandValues.MI_FT.Beta.coherence, BandValues.MI_FT.Gamma.coherence];
    BandValues_MI_DB_coh = [BandValues.MI_DB.Delta.coherence, BandValues.MI_DB.Theta.coherence, BandValues.MI_DB.Alpha.coherence, BandValues.MI_DB.Beta.coherence, BandValues.MI_DB.Gamma.coherence];
    BandValues_ME_DB_coh = [BandValues.ME_DB.Delta.coherence, BandValues.ME_DB.Theta.coherence, BandValues.ME_DB.Alpha.coherence, BandValues.ME_DB.Beta.coherence, BandValues.ME_DB.Gamma.coherence];
    BandValues_ME_FT_coh = [BandValues.ME_FT.Delta.coherence, BandValues.ME_FT.Theta.coherence, BandValues.ME_FT.Alpha.coherence, BandValues.ME_FT.Beta.coherence, BandValues.ME_FT.Gamma.coherence];

    % Prepare band values for classification based on plv locking
    BandValues_REST_plv = [BandValues.REST.Delta.phaseLocking, BandValues.REST.Theta.phaseLocking, BandValues.REST.Alpha.phaseLocking, BandValues.REST.Beta.phaseLocking, BandValues.REST.Gamma.phaseLocking];
    BandValues_MI_FT_plv = [BandValues.MI_FT.Delta.phaseLocking, BandValues.MI_FT.Theta.phaseLocking, BandValues.MI_FT.Alpha.phaseLocking, BandValues.MI_FT.Beta.phaseLocking, BandValues.MI_FT.Gamma.phaseLocking];
    BandValues_MI_DB_plv = [BandValues.MI_DB.Delta.phaseLocking, BandValues.MI_DB.Theta.phaseLocking, BandValues.MI_DB.Alpha.phaseLocking, BandValues.MI_DB.Beta.phaseLocking, BandValues.MI_DB.Gamma.phaseLocking];
    BandValues_ME_DB_plv = [BandValues.ME_DB.Delta.phaseLocking, BandValues.ME_DB.Theta.phaseLocking, BandValues.ME_DB.Alpha.phaseLocking, BandValues.ME_DB.Beta.phaseLocking, BandValues.ME_DB.Gamma.phaseLocking];
    BandValues_ME_FT_plv = [BandValues.ME_FT.Delta.phaseLocking, BandValues.ME_FT.Theta.phaseLocking, BandValues.ME_FT.Alpha.phaseLocking, BandValues.ME_FT.Beta.phaseLocking, BandValues.ME_FT.Gamma.phaseLocking];
    ...
    save(fullfile(myPath, sprintf('meanAccuracies_corr_5b_22ch_Sub-%03d.mat', numSubjects)), 'meanAccuraciesLDA_corr', 'meanAccuraciesSVM_corr', 'meanAccuraciesDT_corr');
    save(fullfile(myPath, sprintf('meanAccuracies_coh_5b_22ch_Sub-%03d.mat', numSubjects)), 'meanAccuraciesLDA_coh', 'meanAccuraciesSVM_coh', 'meanAccuraciesDT_coh');
    save(fullfile(myPath, sprintf('meanAccuracies_pLV_5b_22ch_Sub-%03d.mat', numSubjects)), 'meanAccuraciesLDA_plv', 'meanAccuraciesSVM_plv', 'meanAccuraciesDT_plv');

    %% Save Local Accuracies (LDA, SVM, DT)
    save(fullfile(myPath, sprintf('localAccuracies_lda_corr_5b_22ch_Sub-%03d.mat', numSubjects)), 'localAccuracies_lda_corr');
    save(fullfile(myPath, sprintf('localAccuracies_lda_coh_5b_22ch_Sub-%03d.mat', numSubjects)), 'localAccuracies_lda_coh');
    save(fullfile(myPath, sprintf('localAccuracies_lda_plv_5b_22ch_Sub-%03d.mat', numSubjects)), 'localAccuracies_lda_plv');

    save(fullfile(myPath, sprintf('localAccuracies_svm_corr_5b_22ch_Sub-%03d.mat', numSubjects)), 'localAccuracies_svm_corr');
    save(fullfile(myPath, sprintf('localAccuracies_svm_coh_5b_22ch_Sub-%03d.mat', numSubjects)), 'localAccuracies_svm_coh');
    save(fullfile(myPath, sprintf('localAccuracies_svm_plv_5b_22ch_Sub-%03d.mat', numSubjects)), 'localAccuracies_svm_plv');

    save(fullfile(myPath, sprintf('localAccuracies_dt_corr_5b_22ch_Sub-%03d.mat', numSubjects)), 'localAccuracies_dt_corr');
    save(fullfile(myPath, sprintf('localAccuracies_dt_coh_5b_22ch_Sub-%03d.mat', numSubjects)), 'localAccuracies_dt_coh');
    save(fullfile(myPath, sprintf('localAccuracies_dt_plv_5b_22ch_Sub-%03d.mat', numSubjects)), 'localAccuracies_dt_plv');
...
save(fullfile(myPath, sprintf('overall_FC_5b_22ch.mat')), 'overallMeanAccuracies');
