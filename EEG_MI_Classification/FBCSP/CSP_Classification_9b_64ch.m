...
numChannels = 64;  % Assuming 64 channels from your EEG setup
fbands = 9;        % Adjust according to the number of frequency bands you're using
...
for numSubjects = 1:totalSubjects
    ...
    load(fullfile(mypath, sprintf('sub%03d_9BandValues.mat', numSubjects)), ...
    ...
    numFeaturesList = [10, 20, 30, 40, 90];
...
subjectMeanAccuraciesLDA = cell(numSubjects, 1);
    ...
    meanAccuraciesFileSVM = fullfile(mypath, sprintf('CSP_Accuracies_svm_9b_Sub-%03d.mat', numSubjects));
    meanAccuraciesFileDT = fullfile(mypath, sprintf('CSP_Accuracies_dt_9b_Sub-%03d.mat', numSubjects));
    meanAccuraciesFileLDA = fullfile(mypath, sprintf('CSP_Accuracies_lda_9b_Sub-%03d.mat', numSubjects));
...
finalSavePath = fullfile(mypath, 'AllSubjects_AccuracyResults.mat');
