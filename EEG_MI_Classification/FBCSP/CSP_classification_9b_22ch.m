...
for numSubjects = 1:totalSubjects
    ...
    load(fullfile(mypath, sprintf('concatenated_9b_values_sub%03d.mat', numSubjects)), ...
    ...
    meanAccuraciesFileSVM = fullfile(mypath, sprintf('CSP_Accuracies_svm_9b_22ch_Sub-%03d.mat', numSubjects));
    meanAccuraciesFileDT = fullfile(mypath, sprintf('CSP_Accuracies_dt_9b_22ch_Sub-%03d.mat', numSubjects));
    meanAccuraciesFileLDA = fullfile(mypath, sprintf('CSP_Accuracies_lda_9b_22ch_Sub-%03d.mat', numSubjects));
...
finalSavePath = fullfile(mypath, 'AllSubjects_AccuracyResults_22ch_9b.mat');
