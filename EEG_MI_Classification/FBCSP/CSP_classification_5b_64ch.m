...
for numSubjects = 1 :totalSubjects
    ...
    load(fullfile(mypath, sprintf('sub%03d_5BandValues.mat', numSubjects)), ...
    ...
    meanAccuraciesFileSVM = fullfile(mypath, sprintf('CSP_Accuracies_svm_5b_Sub-%03d.mat', numSubjects));
    meanAccuraciesFileDT = fullfile(mypath, sprintf('CSP_Accuracies_dt_5b_Sub-%03d.mat', numSubjects));
    meanAccuraciesFileLDA = fullfile(mypath, sprintf('CSP_Accuracies_lda_5b_Sub-%03d.mat', numSubjects));
